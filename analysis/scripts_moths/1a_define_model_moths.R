...
domain = Jsmm::jsmm_add_triangulation(domain = domain_p, max_t_area = max_t_area , min_t_angle = min_t_angle)


Jsmm::plot_domain(domain = domain, customize_plot = customize_plot)
