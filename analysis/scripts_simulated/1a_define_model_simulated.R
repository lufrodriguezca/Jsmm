...
domain_p = creating_domain_from_locations(lc = lc, lc_label = lc_label, 
                                          buffer_x = buffer_x, 
                                          buffer_y = buffer_y, 
...
domain = jsmm_add_triangulation(domain = domain_p, max_t_area = max_t_area, 
...
for(method in c("ICP","CCP")){
  ...
  plot_observation_effort(observation_effort , xlab = "Time", ylab = "Location",
